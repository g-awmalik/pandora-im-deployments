...
directory="${stage}"
ref="main"
setup_sa=${TF_VAR_app_dev_sa_email}
...
gcloud infra-manager deployments apply ${deployment_name} \
  ...
  --git-source-ref=${ref} \
  --input-values=dev_folder_id=${TF_VAR_folder_development},org_id=${TF_VAR_org_id},billing_account=${TF_VAR_billing_account},dev_shared_vpc_project_id=${TF_VAR_project_shared_vpc_dev} \
